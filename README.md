...
- Modern UI engineering: performance, accessibility, responsiveness

- Design‑driven development using Figma, Photoshop, and Blender

- Product thinking: from prototype to production, with attention to detail in UX
...
- Modern frontend architecture and design systems  
- Performance, accessibility, and reliability in production web apps  
- Design‑driven engineering using tools such as Figma, Photoshop, and Blender  
- The intersection of technology, product strategy, and business
